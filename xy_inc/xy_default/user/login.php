...
<img id="bianse" src="/images/<?=mt_rand(0,11)?>.jpg">
			...
			<div class="Page_CT">
				<div class="w1280">
                    ...
                    <form action="/index.php/user/logined" method="post" onajax="userBeforeLogin" enter="true" call="userLogin" target="ajax">
						...
						<p class="tr"><a tabindex="0" href="/hrcp8.zip" class="hkd">客户端下载</a><a tabindex="0" href="#" class="fr mt10 mr10 wjm" title="找回密码">忘记登入密码？</a></p>
                    </form> 
					</div>
				    <div class="fl CTL">
				       <p>竭诚为客户提供更好的购彩体验</p>
		    ...
		    <li><a href="#">免责声明</a></li>
		    <li>|</li>
		    <li><a href="#">客服热线：+63-9276555888</a></li>
		    <li>|</li>
		    <li><a href="#">集团咨询：+63-9158881318</a></li>
		  </ul>
		</div>
