...
<head>
	...
	<title><?php $this->settings['webName']?></title>
...
<!--div id="mainbody"-->
<div id="mainbody" style="margin-top:0px;">
...
<input type="hidden" name="topForm" value="topForm">
			...
			<div class="main" >
				<div class="notice-area" stype="margin-top:0px;backgtound-color:#F00; ">
					...
					<div class="qq-guest">
						<a href="#" style="color:#00ffcb" title="点击与QQ客服对话" onclick="qqkf();">QQ客服</a>
					</div>
					<div class="khd">
							<a href="http://<?php $_SERVER['HTTP_HOST']?>/ssc.exe" title="下载客户端">客户端</a>
					</div>
                    ...
                    <div id="news-marquee">
					     <marquee style="cursor: pointer;" onClick="HotNewsHistory();" onMouseOut="this.start();" onMouseOver="this.stop();" direction="up" scrolldelay="15" scrollamount="1" id="msgNews"><?php $this->settings['webGG']?></marquee>
				    </div>
					</div>
				</div>
  ...
  <div class="method-type" id="eleftMenu">
        <div class="userinfo"><?php $this->display('index/inc_user.php');?></div>
						<ul class="method-list high-game">
							...
							<li class="fkffc" data="/index.php/index/game/14/72">
								香港五分彩<font style="color:#ffde00;font-size:12px;">【热】</font>
							</li>
