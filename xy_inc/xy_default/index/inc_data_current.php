...
?>  
    <!--div-->
    <div class="bd" id="kaijiang" type="<?=$this->type?>" ctype="<?=$types[$this->type]['type']?>" style="margin-top:3px;">
      <table width="920px" cellpadding="0" cellspacing="0" border="0" class="game_top_area">
        <tr valign="top">
          ...
          <?php elseif($types[$this->type]['type']==11): //六合彩?>
          ...
          <?php elseif($types[$this->type]['type']==2): //11选5?>
            <td width="440" class="game_top_aright"> 
        	    <div class="kj-bottom"><span class="tit"><span class='gamename' style="color:#e4ff00;font-size:12px"><?=$types[$this->type]['title']?></span>&nbsp;&nbsp;第 <span class="last_issues" style="color:#e4ff00;font-size:12px"><b><?=$lastNo['actionNo']?></b></span> 期 <span id="kjsay"></span></span><img id="voice" class="voice-on"  title="声音开启，点击关闭" onclick="voiceKJ()"><span id="lockgame"></span><div class="clear"></div></div>  
