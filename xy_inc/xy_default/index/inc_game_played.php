...
<div class="game-btn2" style="margin-top:3px">
	<?php if($playeds): ?>
		<?php foreach($playeds as $played): ?>
			<?php if($this->played==$played['id']): ?>
				<?php $tpl=$played['playedTpl']; ?>
			<?php endif; ?>
...
<?php 
	if(!$played['enable']) {
		echo '<div style="height:100px;text-align:center;color:#f00">暂无玩法</div>';
		return;
	} 
